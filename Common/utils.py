...
class Util(object):
    ...
    @staticmethod
    def getAlphaNumeric(length, type_let='letters'):
    ...
    @staticmethod
    def verify_text_contains(actualText, expectedText):
    ...
    @staticmethod
    def verifyTextMatch(actualText, expectedText):
    ...
    @staticmethod
    def verifyListMatch(expectedList, actualList):
    ...
    @staticmethod
    def generate_random_number_from_given_data(data):
