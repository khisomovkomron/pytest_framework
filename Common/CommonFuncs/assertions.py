...
class Assertions(WebDriverFactory):
    ...
    def assert_url_doesnt_contains_any_of(self, *text):
        ...
        try:
            ...
            for i in text:
                ...
                assert parsed_text not in current_url, f'Current url "{current_url}" contains text "{text}".'
    ...
    def assert_element_is_not_visible(self, locator='', locator_type='css', timeout=5):
